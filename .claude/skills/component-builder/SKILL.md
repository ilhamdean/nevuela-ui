...
`Charts`, `AI`. After creating a component, **add it to `src/index.ts`** under the right
...
## 4. Accessibility (these are all-day work screens, non-negotiable)
...
// + variant showcases and ≥1 realistic-data story (plausible product data: orders,
//   projects, members, invoices, devices; not tied to one industry)
```
