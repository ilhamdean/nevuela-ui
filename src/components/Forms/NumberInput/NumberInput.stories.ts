 ...
 * quota/limit/count values in settings forms (seat counts, connection
...
/** A realistic settings form snippet: setting a workspace's seat quota. */
export const SeatQuotaForm: Story = {
  render: () => ({
    components: { NumberInput },
    template: `
      <div class="w-80 rounded-xl border border-border bg-surface p-5 shadow-sm">
        <h3 class="text-sm font-semibold text-fg">Seat quota</h3>
