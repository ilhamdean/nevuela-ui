    ...
    template: `
      <div class="w-96">
        <FormField v-bind="args" v-slot="{ bind }">
          <TextInput v-bind="bind" placeholder="e.g. web-prod-01" />
        </FormField>
      </div>`,
  }),
...
export const WithError: Story = {
  args: { error: 'That name is already taken in this project.' },
}
...
export const WithSelect: Story = {
  ...
  args: { label: 'Datacenter region', hint: 'Pick the region closest to your users.' },
}
