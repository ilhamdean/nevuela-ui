...
import { drawerContentVariants, type DrawerVariants } from '.'
...
<template>
  <DialogRoot v-model:open="open">
    ...
    <DialogPortal>
      ...
      />
      <DialogContent :class="drawerContentVariants({ side, size })">
        ...
        <div class="flex-1 overflow-y-auto p-5 text-sm text-fg">
          <slot />
        </div>
