...
const meta = {
  ...
  args: {
    ...
    description: 'NYC1 will undergo network maintenance on Saturday between 02:00–04:00 UTC.',
    dismissible: true,
  },
  render: (args) => ({
    components: { Alert },
  ...
  render: (args) => ({
    ...
    template: `
      <div class="flex w-[560px] flex-col gap-3">
        <Alert tone="info" title="Info" description="A new region is available." />
        <Alert tone="success" title="Backup complete" description="Your Instance snapshot finished successfully." />
...
export const WithActions: Story = {
  render: (args) => ({
    ...
    template: `
      <div class="w-[560px]">
        <Alert tone="warning" title="Add a payment method" description="Add a card to keep your resources running past the trial.">
          <template #actions>
