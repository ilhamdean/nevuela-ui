...
const meta = {
  ...
  render: (args) => ({
    ...
    template: `
      <div class="w-[640px]">
        <Tabs v-bind="args">
          <template #overview><p class="text-sm text-fg-subtle">Record summary and quick stats.</p></template>
          <template #graphs><p class="text-sm text-fg-subtle">Orders, revenue, and refunds over time.</p></template>
          <template #settings><p class="text-sm text-fg-subtle">Plan, notifications, and access.</p></template>
        </Tabs>
      </div>`,
  }),
