 ...
 * payloads, config snippets, and CLI examples in an application UI. Unlike `CopyableField` (a
...
const meta = {
  ...
  args: {
    code: 'name: weekly-digest\nschedule: "0 6 * * 1"\nrecipients:\n  - ops@haldenco.com\n  - finance@haldenco.com\nretries: 3\ntimeout: 15m',
    language: 'yaml',
    filename: undefined,
...
export const WithLineNumbers: Story = {
  args: {
    ...
    code: {
      name: 'weekly-digest',
      schedule: '0 6 * * 1',
      recipients: ['ops@haldenco.com', 'finance@haldenco.com'],
      filters: { status: 'unpaid', olderThanDays: 30 },
    },
    language: 'yaml',
    filename: undefined,
  },
