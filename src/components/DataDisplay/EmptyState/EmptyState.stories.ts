...
const meta = {
  ...
  args: {
    ...
    description: 'Spin up your first Instance to get started — it takes less than a minute.',
    bordered: true,
  },
  render: (args) => ({
    components: { EmptyState, Server, Button },
    setup: () => ({ args }),
    template: `
      <div class="w-[560px]">
        <EmptyState v-bind="args" :icon="Server">
          <template #actions>
