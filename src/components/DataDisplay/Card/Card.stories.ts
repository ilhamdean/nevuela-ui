  ...
  render: (args) => ({
    ...
    template: `
      <div class="w-[420px]">
        <Card v-bind="args">
          <template #header>
            <h3 class="text-base font-semibold text-fg">Order details</h3>
          </template>
          <p class="text-sm text-fg-subtle">
            ORD-4821 · Halden &amp; Co. · 3 line items · $482.00
          </p>
        </Card>
      </div>`,
  }),
      ...
      <div class="w-[420px]">
        <Card content-class="p-0">
          ...
          <ul class="divide-y divide-border">
            <li class="px-5 py-3 text-sm text-fg">Order placed</li>
            <li class="px-5 py-3 text-sm text-fg">Payment captured</li>
            <li class="px-5 py-3 text-sm text-fg">Shipment created</li>
          </ul>
        </Card>
      </div>`,
  }),
